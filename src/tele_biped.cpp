    ...
    while(1)
    {
        if ( read(STDIN_FILENO, &c, 1) == 1) {
            switch (c) {
                ...
                case 'b':
                    std::cout << "'a' key pressed!\n";
                    system("/home/hubo/hongfei/otherRepos/hubo-read-trajectory/hubo-read-trajectory -f 100 -i -n /home/hubo/hongfei/myRepos/HUBO_work/trajs/BipedOverBricks_v2.txt");		
                    break;
                 ...
                 case 'h':
                    ...
                    std::cout << "a :          w3d3 traj   \n";
                    std::cout << "b :          w3d5 traj   \n";
