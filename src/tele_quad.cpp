            ...
            switch (c) {
                ...
                case 'b':
                    if( status == 0) {
                            ...
                            system("/home/hubo/hongfei/otherRepos/hubo-read-trajectory/hubo-read-trajectory -f 100 -i -n /home/hubo/hongfei/myRepos/HUBO_work/trajs/BipedOverBricks_v3.txt");		
                            status = 1;
                             break;
                    }
...
/*
                 ...
                 case 'x':
                    if( status == 1) {
                            ...
                            system("/home/hubo/hongfei/otherRepos/hubo-read-trajectory/hubo-read-trajectory -f 200 -i -n /home/hubo/hongfei/myRepos/HUBO_work/trajs/quadwalk_forward_043.txt");
                            break;
                    } 
                    if( status == 0) {
                            std::cout << "Illegal Input!    status = 0 ! \n";
