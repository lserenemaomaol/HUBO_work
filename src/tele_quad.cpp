            ...
            switch (c) {
                ...
                case 'b':
                    if( status == 0) {
                            ...
                            system("/home/hubo/hongfei/otherRepos/hubo-read-trajectory/hubo-read-trajectory -f 100 -i -n /home/hubo/hongfei/myRepos/HUBO_work/trajs/BipedOverBricks_v8.txt");		
                            status = 1;
                             break;
                    }
